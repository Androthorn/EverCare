...
/* package EverCare-0.1.0.0 */
#ifndef VERSION_EverCare
#define VERSION_EverCare "0.1.0.0"
#endif /* VERSION_EverCare */
#ifndef MIN_VERSION_EverCare
#define MIN_VERSION_EverCare(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EverCare */
...
#define CURRENT_COMPONENT_ID "EverCare-0.1.0.0-inplace-EverCare"
